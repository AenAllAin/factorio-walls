...
{
  {
    ...
    --minable = {mining_time = 1, result = "composite-wall"},
    ...
    pictures =
    {
      single =
      {
        layers =
        {
          ...
          {
            filename = "__n^3_walls__/graphics/entity/plastic-wall/wall-cap.png",
            priority = "extra-high",
            width = 22,
            height = 42,
            shift = {0, -0.15625}
          ...
          {
            filename = "__n^3_walls__/graphics/entity/powered-wall/power-pole.png",
            priority = "extra-high",
            width = 22,
            height = 42,
            shift = {0, -0.15625}
